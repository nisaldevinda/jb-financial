...
const FundStewardSection: React.FC<FundStewardSectionProps> = ({
  ...
  return (
    <section className="bg-white px-4 py-8 md:p-20 2xl:px-40 2xl:py-20 flex flex-col gap-4 md:gap-16">
      ...
      <div className="flex flex-col md:flex-row gap-4 md:gap-12 bg-off-white rounded-2xl border-2 border-solid border-gray-300 p-8 md:p-12">
        <div className="flex flex-col justify-center gap-8 md:gap-12 items-center w-full md:w-1/3">
        ...
        <div className="w-full md:w-2/3 flex flex-col gap-1 md:gap-4 justify-center">
