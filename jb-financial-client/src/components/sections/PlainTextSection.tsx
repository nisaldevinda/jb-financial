...
const PlainTextSection: React.FC<PlainTextSectionProps> = ({}) => {
  return (
    <section className="bg-white px-4 py-8 md:p-20 2xl:px-40 2xl:py-20 flex flex-col gap-4 md:gap-16 items-center">
      ...
      <p className="bodyText text-neutral-mid text-center w-full md:w-[80%]">
