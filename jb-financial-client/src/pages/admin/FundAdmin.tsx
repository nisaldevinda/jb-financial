...
const ChartCard: React.FC<ChartCardProps> = ({ title, subtitle, fundType, fundData, onSubmit }) => {
  ...
  return (
      <div className="flex flex-col bg-[#fbfbfd] rounded-2xl border-2 border-solid border-gray-300 gap-8 pb-8">
        ...
        <div className="p-4 md:p-8 flex flex-col gap-4">
          ...
          <div className="flex-grow">
            <div className="mb-2 block">
              <label htmlFor="date" className="switzer-md">Select Date</label>
            </div>
            <input
                type="date"
                id="date"
...
const FundAdmin: React.FC = () => {
  ...
  const [valueEquityFundPerformanceDate, setValueEquityFundPerformanceDate] = useState([]);
